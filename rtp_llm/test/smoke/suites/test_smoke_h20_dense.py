...
SMOKE_CASES = {'dense_generation_prefill_cuda_graph': {'task_info': 'data/model/qwen25/q_r_generation_prefill_cuda_graph.json',
                                         ...
                                         'timeout': 600},
 'dense_generation_prefill_cuda_graph_fallback': {'task_info': 'data/model/qwen25/q_r_generation_prefill_cuda_graph_fallback.json',
                                                  ...
                                                  'markers': ['smoke', 'cuda', 'H20'],
                                                  'timeout': 600},
 'dense_fp8kv_cudagraph': {'task_info': 'data/model/qwen25/q_r_new_model_py_fp8_kv_cache_cudagraph.json',
                           'smoke_args': '--warm_up 0 --seq_size_per_block 64 '
                                         '--act_type BF16 --test_block_num 1000 '
                                         '--fp8_kv_cache 1 --enable_cuda_graph 1  '
                                         '--disable_flash_infer 1',
                           'gpu_type': 'H20',
                           'platform': 'cuda',
                           'markers': ['smoke', 'cuda', 'H20'],
                           'timeout': 600},
 'dense_fp8kv_flashinfer_prefill': {'task_info': 'data/model/qwen25/q_r_new_model_py_fp8_kv_cache_flashinfer_prefill.json',
                                    'smoke_args': '--warm_up 0 --seq_size_per_block 64 '
                                                  '--act_type BF16 --test_block_num '
                                                  '1000 --fp8_kv_cache 1 '
                                                  '--enable_cuda_graph 0 '
                                                  '--disable_flash_infer 0 '
 ...
 'dense_fp8_prequant_tp2': {'task_info': 'data/model/qwen3/q_r_block_fp8.json',
                            'smoke_args': '--disable_flash_infer 1 --act_type BF16 '
 ...
 'dense_fp8pb_dynamic': {'task_info': 'data/model/qwen3/q_r_h20.json',
                         'smoke_args': '--disable_flash_infer 1 --quantization '
                                       'FP8_PER_BLOCK --act_type BF16 --warm_up 0',
                         'gpu_type': 'H20',
                         'platform': 'cuda',
                         'markers': ['smoke', 'cuda', 'H20'],
                         'timeout': 600},
 'dense_fp8pt_dynamic': {'task_info': 'data/model/qwen3/q_r_h20_per_tensor_w13.json',
                         'smoke_args': '--disable_flash_infer 1 --quantization '
                                       'FP8_DYNAMIC_PER_TENSOR --act_type BF16',
                         'gpu_type': 'H20',
                         'platform': 'cuda',
                         'markers': ['smoke', 'cuda', 'H20'],
                         'timeout': 600},
 'dense_override_yarn': {'task_info': 'data/model/qwen3/q_r_override_yarn.json',
                         'smoke_args': '--reserver_runtime_mem_mb 20000 '
                                       ...
                                       '--seq_size_per_block 64 --act_type BF16 '
                                       '--warm_up 0',
                         ...
                         'markers': ['smoke', 'cuda', 'H20'],
                         'timeout': 600},
 'dense_pdfusion_ratio_prompt_batch_alternation': {'task_info': 'data/model/qwen25/q_r_pdfusion_ratio_prompt_batch.json',
                                                   'smoke_args': '--warm_up 0 '
                                                                 '--seq_size_per_block '
                                                                 '64 --act_type BF16 '
                                                                 '--disable_flash_infer '
                                                                 '1 --tp_size 1 '
                                                   ...
                                                   'markers': ['smoke', 'cuda', 'H20'],
                                                   'timeout': 600},
 'dense_prompt_scoring': {'task_info': 'data/model/qwen25/q_r_prompt_scoring.json',
                          'smoke_args': '--act_type BF16 --warm_up 0',
                          'gpu_type': 'H20',
                          'platform': 'cuda',
                          'markers': ['smoke', 'cuda', 'H20'],
