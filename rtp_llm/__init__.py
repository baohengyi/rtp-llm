...
# conftest.py's slicing has run (signalled by `sys._RTP_CONFTEST_DONE` at
# the END of its module-level code), eager ops loading is safe and DESIRED
# for downstream import correctness.
