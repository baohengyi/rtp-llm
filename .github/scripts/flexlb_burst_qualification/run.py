"""Run one unchanged original burst-P99 method against exact public W sources."""
...
def main():
    ...
    try:
        ...
        proof["accepted"] = code == 0 and len(cases) == 1 and actual == expected and all(c["status"] == "pass" for c in cases)
